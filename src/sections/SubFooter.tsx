...
import subfooter from "@/assets/images/subfooter.webp";
...
export default function SubFooter() {
  ...
  /**
   * Obuna do'kon operatoriga Telegram orqali boradi — buyurtmalar kabi.
   *
   * Ilgari bu yerda faqat "rahmat" xabari chiqib, email hech qayerga
   * yozilmasdi: mijoz obuna bo'ldim deb o'ylardi, do'kon esa uning
   * manzilini hech qachon ko'rmasdi. Endi forma faqat yuborish
   * tasdiqlangandan keyin tozalanadi.
   */
  ...
  return (
    ...
    >
      ...
      >
        ...
        {errors.email && (
          <p className="text-[12px] text-[#FF5630]">
