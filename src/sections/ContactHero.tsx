export default function ContactHero() {
  return (
    <section className="max-w-310 mx-auto px-5 my-15 flex flex-col gap-6">
      <h1 className="w-[57%] font-medium text-[54px]/[54px] leading-[-1px]">
        We believe in sustainable decor. We’re passionate about life at home.
      </h1>
      <p className="w-[65%] text-[16px] text-[#6C7275]">
